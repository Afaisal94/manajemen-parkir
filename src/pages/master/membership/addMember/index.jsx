...
import { createMember } from "../../../../hooks/useMember";
...
function AddMember() {
  ...
  const { mutate } = useMutation({
    mutationFn: async () => {
      await createMember({ nama, telepon, nopol, noStnk, tglExpired });
    },
    onSuccess: async () => {
  ...
  const handleSubmit = async (event) => {
    ...
    await mutate({ nama, telepon, nopol, noStnk, tglExpired }); 
    navigate("/membership");
  };
  return (
    <MasterLayout>
      <div className="container-fluid px-4">
        <h1 className="mt-4">Tambah Data Member</h1>
